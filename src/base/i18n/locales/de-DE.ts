export default defineI18nLocale(() => ({
  messages: {
    ...
    general: {
      ...
      readOnly: "Nur-Lesen",
      tagline: "Inspirierende Lösungen für Ihre Bedürfnisse",
      demo: "Kostenlose Demonstration",
      demoShort: "Sehen Sie, wie wir arbeiten",
      demoLong:
        "Erleben Sie unsere kostenlose Demonstration und sehen Sie, wie sich Ihr alter Boden direkt vor Ihren Augen in eine brandneue Oberfläche verwandelt.",
      demoBtn: "Jetzt buchen",
    ...
    shop: {
      ...
      orderNotePlaceholder:
        "Nachricht zu Ihrer Bestellung, zum Beispiel zur Lieferung.",
      orderThanks:
      ...
      addProductsInYourCart:
        "Bitte fügen Sie einige Produkte in Ihren Warenkorb hinzu.",
